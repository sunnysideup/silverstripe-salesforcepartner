...
class soapType
{
    ...
    const tnsjson = 'tns:json';

    const urnRelationshipReferenceTo = 'urn:RelationshipReferenceTo';

    const urnJunctionIdListNames = 'urn:JunctionIdListNames';
    ...
    const tnsStringList = 'tns:StringList';

    const tnsChangeEventHeader = 'tns:ChangeEventHeader';
}
